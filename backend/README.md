...
## Project Structure
    ...
    ├── accounting_template_38063  # Django project configurations
...
1. Clone this repo and `cd accounting_template_38063`
...
2. Clone this repo and `cd accounting_template_38063`
